            ...
            <div className="bg-white border border-zinc-200 rounded-xl shadow-lg w-[30rem] p-10 relative">
                ...
                <div className="flex items-center gap-2 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2v2m0 16v2m8-10h2M2 12H4m14.364-6.364l1.414 1.414M4.222 19.778l1.414-1.414M19.778 19.778l-1.414-1.414M4.222 4.222l1.414 1.414"/>
                    </svg>
                ...
                <div className="flex items-center mb-4">
                    ...
                    <label htmlFor="important" className="ml-2 text-gray-700 scale-110">مهم</label>
                </div>
